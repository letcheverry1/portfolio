...
import {
    ...
    Award, FileText, Download, Brain, Layout, TrendingUp, X, ExternalLink, Box, PenTool
} from 'lucide-react';
import ProjectShowcase from '../components/ProjectShowcase';
import AnomalyDashboard from '../components/AnomalyDashboard';
import Navbar from '../components/Navbar';
import Footer from '../components/Footer';
import { FadeInUp, Section, SocialLink, containerVariants, itemVariants } from '../components/UI';
import { globalData, translations } from '../data';

// --- TECH MARQUEE COMPONENT (Local to Home) ---
function TechMarquee() {
    const techStack = [
        ...
        { name: "SQL", type: "icon", icon: Database, color: "text-blue-400" },
        { name: "Solid Edge", type: "icon", icon: Box, color: "text-red-500" },
        { name: "AutoCAD", type: "icon", icon: PenTool, color: "text-red-600" },
